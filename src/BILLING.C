  ...
  while (1) {
    if ((cp1 = strchr(cp, '%')) != NULL) {
      *cp1 = 0;                               // null terminate beginning of string
      ...
      if ((cp2 = strchr(cp1, '%')) != NULL) { // variable name found
...
static void AddDateOkClick(void) {
  ...
  d1 = adddateentry1.day + (adddateentry1.month * 100L) + (adddateentry1.year * 10000L);

  d2 = adddateentry2.day + (adddateentry2.month * 100L) + (adddateentry2.year * 10000L);
...
static void DateChange(void) {
  ...
  {
    d1 = adddateentry1.day + (adddateentry1.month * day_tab[1][adddateentry1.month]) + (adddateentry1.year * 365);
  } else // it's NOT a leap year!!
  {
    d1 = adddateentry1.day + (adddateentry1.month * day_tab[0][adddateentry1.month]) + (adddateentry1.year * 365);
  }
  if ((adddateentry2.year % 4) == 0) // it's a leap year!!
  {
    d2 = adddateentry2.day + (adddateentry2.month * day_tab[1][adddateentry2.month]) + (adddateentry2.year * 365);
  } else // it's NOT a leap year!!
  {
    d2 = adddateentry2.day + (adddateentry2.month * day_tab[0][adddateentry2.month]) + (adddateentry2.year * 365);
  }
#endif
  if (d1 >= d2) {
